...
@RequestMapping("/pt")
        ...
        public class PatientController {
            ...
            @PostMapping("/pt") //Post ->http://localhost:8080/patient
            ...
            @PutMapping("/pt1")
            public ResponseEntity<AppResponse<PatientDto>> updatePatientInformation(@RequestBody PatientDto dto) throws AccountNotFoundException {
