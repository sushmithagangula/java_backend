package com.ani.banking.menu;

import com.ani.banking.BnkDbService.BnkService;
import com.ani.banking.db.BankingConnection;
    ...
    public void showMenu() throws SQLException {
        ...
        while (true) {
            ...
            if (ch == 1) {
                ...
                Date dt = Date.valueOf(scanner.next());
                System.out.println("enter the status");
                Boolean status = Boolean.valueOf(scanner.next());
                service.createBnkAcc(ac_num, amount, ac_hl_nm, dt, status);
                // service.createBnkAcc(5,500,"sushu", Date.valueOf(LocalDate.now()),true);
            }
            if (ch == 2) {
